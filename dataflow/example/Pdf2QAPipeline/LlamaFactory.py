...
class LlamaFactoryTrainer:
    ...
    def get_default_config(self):
        ...
        return {
            ...
            # === 输出配置 ===
            "output_dir": "./saves/qwen2.5_7b_sft_model",
    ...
    def check_environment(self):
        ...
        data_files = ["./data/qa.json", "./data/dataset_info.json"]
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true",
                        help="Preview only, don't execute training")
    ...
    # Create trainer
    trainer = LlamaFactoryTrainer(args.config)
    ...
    # Start training
    success = trainer.start_training(dry_run=args.dry_run)

    if success:
        print(f"\nOperation completed!")
        if not args.dry_run:
            print(f"Model saved to: ./saves/qwen2.5_7b_sft_model")
    else:
        sys.exit(1)
