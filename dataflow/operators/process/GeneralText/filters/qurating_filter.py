...
class QuratingFilter(OperatorABC):
    ...
    def __init__(self, min_scores: dict = {'writing_style': 0,'required_expertise': 0,'facts_and_trivia': 0,'educational_value': 0}, max_scores: dict = {'writing_style': 9,'required_expertise': 9,'facts_and_trivia': 9,'educational_value': 9}, model: str = 'princeton-nlp/QuRater-1.3B', tokens_field: str = 'input_ids', tokens: int = 512, 
        ...
        self.scorer = QuratingScorer(model=model, tokens_field=tokens_field, tokens=tokens, map_batch_size=map_batch_size, 
