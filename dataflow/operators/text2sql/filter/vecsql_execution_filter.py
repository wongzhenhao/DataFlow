...
class VecSQLExecutionFilter(OperatorABC):
    ...
    def filter_select_sql(self, sql):
        ...
        '''
        # This regex is used to remove comments from the SQL query.
        ...
        # This checks if the query is a SELECT or WITH statement.
    ...
    def check_column(self, dataframe):
        # This checks if the required columns are in the dataframe.
